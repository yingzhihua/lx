...
void init_device(pass_data* s)
{
    ...
    s->fmt.fmt.pix.width	= 2592;//640;
    s->fmt.fmt.pix.height	= 1944;//480;
...
qDebug("bytesperline=%d,sizeimage:%d\n",s->fmt.fmt.pix.bytesperline,s->fmt.fmt.pix.sizeimage);
